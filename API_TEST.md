...
# 프로덕션
curl -X POST "https://jhwwon-travel.duckdns.org/chat" \
  -H "Content-Type: application/json" \
  -d "{\"message\": \"도쿄 여행 추천해줘\", \"session_id\": \"test_001\"}"
```
...
# 프로덕션
curl -X POST "https://jhwwon-travel.duckdns.org/chat/stream" \
  -H "Content-Type: application/json" \
  -d "{\"message\": \"제주도 여행 추천해줘\", \"session_id\": \"test_001\"}" \
  --no-buffer
```
...
# 프로덕션
curl "https://jhwwon-travel.duckdns.org/weather/Tokyo"
```
...
# 프로덕션
curl "https://jhwwon-travel.duckdns.org/health"
```
